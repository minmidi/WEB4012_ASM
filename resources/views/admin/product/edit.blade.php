...
@section('active','Sửa sản phẩm')
@section('active_3','active')
@section('url','Sửa sản phẩm')
@section('main')
    ...
    <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data" role="form" >
        ...
        <div class="form-group m-3">
            ...
            <input type="text" class="form-control" name="name" id='name' placeholder="Nhập tên sản phẩm" value="{{ $product->name }}">
        </div>
        ...
        <!-- End validate product name input -->
         ...
         <div class="form-group m-3">
            ...
            <div class="mb-3">
                <img src="{{ asset('images/posts/'.$product->images) }}" alt="Ảnh" style="width: 200px; height:150px;">
            </div>
            ...
            <div class="row">
                @foreach ($category as $categories )
                    <div class="form-check ml-3">
                        <input class="form-check-input" type="checkbox" name="category_id[]" id="category_id" value="{{ $categories->id }} {{$categories->category_id === $categories->id ? "checked" : ""}}">
